...
import { Cookie, Ban, Cog, BarChart3, Settings, Database, Users, RefreshCw } from "lucide-react";
...
const sectionIcons = [Cookie, Ban, Cog, BarChart3, Settings, Database, Users, RefreshCw];
const sectionKeys = ["object", "noMarketing", "functional", "analytics", "preferences", "data", "thirdParty", "update"] as const;

export function CookiePolicyContent() {
  const { locale } = useLanguage();
  const t = messages[locale as keyof typeof messages]?.cookies || messages.fr.cookies;
